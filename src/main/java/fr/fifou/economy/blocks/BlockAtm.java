...
public class BlockAtm extends Block
{
    ...
    {
        super(Material.IRON);
        BlocksRegistery.setBlockName(this, "block_atm");
        this.setDefaultState(this.blockState.getBaseState().withProperty(FACING, EnumFacing.NORTH));
        this.setUnlocalizedName("block_atm");
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            if (playerIn.inventory.getStackInSlot(i) != null && playerIn.inventory.getStackInSlot(i).getItem() instanceof ItemCreditcard)
            {
                ItemStack itemstack = playerIn.inventory.getStackInSlot(i);

                if (itemstack.hasTagCompound() && itemstack.getTagCompound().getBoolean("Owned"))
                {
                    playerIn.openGui(ModEconomy.instance, 1, worldIn, pos.getX(), pos.getY(), pos.getZ());
                }
            }
        }
