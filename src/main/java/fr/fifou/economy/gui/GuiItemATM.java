...
public class GuiItemATM extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.fontRenderer.drawString(TextFormatting.BOLD + I18n.format("title.ownerCard", new Object[0]) + ": " + this.owner, this.width / 2 - 75, this.height / 2 - 55, 0);
        this.fontRenderer.drawString(TextFormatting.BOLD + I18n.format("title.fundsCard", new Object[0]) + ": " + this.funds_s, this.width / 2 - 75, this.height / 2 - 45, 0);
